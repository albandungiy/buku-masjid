...
<div class="page-header mt-0">
    ...
    <div class="page-options d-flex">
        ...
        <div class="form-group mt-4 mt-sm-0">
            ...
            {{ link_to_route('reports.finance.summary_excel', __('report.export_excel'), ['year' => $startDate->format('Y'), 'month' => request('month', $startDate->format('m')), 'bank_account_id' => request('bank_account_id')], ['class' => 'btn btn-secondary mr-1']) }}
        </div>
        @if (request('month') != '00')
